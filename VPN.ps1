...
$Domain = 'kemponline' # Name of the domain.

$TemplateName = 'VPN' # Name of the test VPN connection you created in the tutorial. 

$ProfileName = 'AlwaysOn VPN' # Name of the profile we are going to create.

$Servers = 'aovpn.kemponline.co.uk' #Public or routable IP address or DNS name for the VPN gateway.

$DnsSuffix = 'ad.kemponline.co.uk' # Specifies one or more commas separated DNS suffixes. 

$DomainName = '.ad.kemponline.co.uk' #Used to indicate the namespace to which the policy applies. Contains `.` prefix.
